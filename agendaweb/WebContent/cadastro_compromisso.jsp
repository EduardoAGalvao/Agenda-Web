...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% 
		...
		%>
			...
			<head>
			<meta charset="UTF-8">
			<title>Agenda Web - Novo Compromisso</title>
			...
			<body>
						...
						<div class="col-md-9">
							<div class="card">
								...
								<div class="card-body">
									...
									<!-- Lista de erros. Visível somente quando houver erros -->
      						<div id="alerta_erro">
      							<ul id="lista_erros"></ul>
      						</div>
								
									<form id="formulario_cadastro_compromisso" action="CadastroCompromissoServlet" method="post">
										<div class="form-row">
											<div class="form-group col-md-12">
												<label for="txt_descricao">Descrição:</label>
												<input id="txt_descricao" class="form-control" type="text" name="txt_descricao"/>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="txt_local">Local:</label>
												<input id="txt_local" class="form-control" type="text" name="txt_local"/>
											</div>
											<div class="form-group col-md-3">
												<label for="txt_dataconclusao">Data de Conclusão:</label>
												<input id="txt_dataconclusao" class="form-control" type="date" name="txt_dataconclusao"/>
											</div>
											<div class="form-group col-md-3">
												<label for="txt_horario">Horário:</label>
												<input id="txt_horario" class="form-control" type="time" name="txt_horario"/>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12">
												<label for="txt_observacoes">Observações:</label>
												<textarea class="col-md-12" id="txt_observacoes" name="txt_observacoes"></textarea>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-3">
												<label for="txt_conclusao">Status: </label><br>
												Concluído <input type="checkbox" id="txt_conclusao" name="txt_conclusao" value="true"/>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12 text-right mt-3">
												<a class="btn btn-danger" href="compromissos.jsp">Cancelar</a>
												<button id="btn_cadastro_compromisso" class="btn btn-success" type="submit">Salvar</button>
											</div>
										</div>
									</form>
								</div>
				...
				<!-- JS files -->
				<script type="text/javascript" src="js/valida_compromisso.js"></script>
			</body>
			</html>
