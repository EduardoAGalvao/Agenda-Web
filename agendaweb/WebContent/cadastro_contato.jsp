...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% 
		...
		%>
			...
			<head>
			<meta charset="UTF-8">
			<title>Agenda Web - Novo Contato</title>
									...
									<form id="formulario_cadastro_contato" action="CadastroContatoServlet" method="post">
										<div class="form-row">
											<div class="form-group col-md-8">
												...
												<input id="txt_nome" class="form-control" type="text" name="txt_nome"/>
											</div>
											<div class="form-group col-md-4">
												<label for="txt_datanascimento">Data de Nascimento:</label>
												<input id="txt_datanascimento" class="form-control" type="date" name="txt_datanascimento"/>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-6">
												<label for="txt_email">Email:</label>
												<input id="txt_email" class="form-control" type="email" name="txt_email"/>
											</div>
											<div class="form-group col-md-3">
												<label for="txt_telefone">Telefone:</label>
												<input id="txt_telefone" class="form-control" type="text" name="txt_telefone"/>
											</div>
											<div class="form-group col-md-3">
										...
										<div class="form-row">
											<div class="form-group col-md-12">
												...
												<input id="txt_endereco" class="form-control" type="text" name="txt_endereco"/>
											</div>
										</div>
										<div class="form-row">
											<div class="form-group col-md-12 text-right mt-3">
												<a class="btn btn-danger" href="contatos.jsp">Cancelar</a>
												<button id="btn_cadastro_contato" class="btn btn-success" type="submit">Salvar</button>
											</div>
										</div>
									</form>
								</div>
