...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% 
		...
		%>
			...
			<head>
			<meta charset="UTF-8">
			<title>Agenda Web - Excluir Contato</title>
						...
						<div class="col-md-9">
							<div class="card">
								...
								<div class="card-body">
									...
									<form id="formulario_cadastro_contato" action="ExcluirContatoServlet" method="post">
										<div class="form-row">
										...
										<div class="form-row">
											<div class="form-group col-md-12 text-right mt-3">
												<a class="btn btn-warning" href="contatos.jsp">Cancelar</a>
												<button class="btn btn-danger" type="submit">Excluir Contato</button>
											</div>
										</div>
									</form>
								</div>
