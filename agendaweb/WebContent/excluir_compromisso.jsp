...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	%>
			...
			<head>
			<meta charset="UTF-8">
			<title>Agenda Web - Excluir Compromisso</title>
						...
						<div class="col-md-9">
							<div class="card">
								...
								<div class="card-body">
									...
									<form id="formulario_cadastro_contato" action="ExcluirCompromissoServlet" method="post">
										<div class="form-row">
										...
										<div class="form-row">
											<div class="form-group col-md-12 text-right mt-3">
												<a class="btn btn-warning" href="compromissos.jsp">Voltar aos compromissos</a>
												<button class="btn btn-danger">Excluir Compromisso Registrado</button>
											</div>
										</div>
									</form>
								</div>
