...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% 
		...
		%>
			...
			<head>
			<meta charset="UTF-8">
			<title>Agenda Web - Atualizar Contato</title>
							...
							<div class="card">
      						...
      						<div id="alerta_erro">
      							<ul id="lista_erros"></ul>
									...
									<form id="formulario_cadastro_contato" action="AtualizarContatoServlet" method="post">
										<div class="form-row">
											<div class="form-group col-md-8">
												<input id="txt_id" type="hidden" name="txt_id" value="<%= contato.getId() %>"/>
										...
										<div class="form-row">
											<div class="form-group col-md-12 text-right mt-3">
												...
												<button id="btn_cadastro_contato" class="btn btn-warning" type="submit">Atualizar Contato</button>
											</div>
										</div>
									</form>
								</div>
